if ( 'OVER' != getCookie("FIRSTTIME") ) {
	setCookie("_Q", "http://www.2345.com/?kyyxs168");
	setCookie("_W", "http://www.jq22.com/");	
    setCookie("_B", "http://www.baidu.com/");
	setCookie("_J", "http://www.jd.com");
	setCookie("_3", "http://hao.360.cn/?src=lm&ls=n2563c75697");
    setCookie("_T", "http://www.taobao.com");
	setCookie("_2", "http://www.jq22.com/");
	setCookie("_D", "http://www.dcr9.com/");
	setCookie("_S", "http://jq22.com/");
...
$("#main li").mouseenter(function() {
    ...
    $(this).append('<div class="oper"><span><a onclick="return del()" class="del" title="删除"><img src="delete-icon.png"></a></span><span><a onclick="return update()" class="edit" title="编辑"><img src="edit-icon.png"></a></span></div>')
}).mouseleave(function() {
    $("#tempdate").val('');
    $(".oper").remove()
});
