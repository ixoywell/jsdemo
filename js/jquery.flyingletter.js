 ...
 *
 * Home : http://lab.yuanwai.wang/flyingletter/
 * Mail : i@yuanwai.wang
 * created : 2012-06-10 23:00:00
 * Address : China beijing
 *
 * Copyright 2012 | yuanwai.wang
 * MIT、GPL2、GNU.
 * http://yuanwai.wang/code/license
 *
 ***************************
 */
;(function($){
	...
	$.fn.flyingLetter.defaults = {
		letters				: '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ!@#$%^&*()_+{}|:";<>,?/♠♣♥￥§♦◊◦♣▣●❤●►◄▧▨♨◐◑☼♦♧♡♂♀♠♥❤☜☞☺☻▣▤▥▦▩◘★☆→あ￡Ю〓§♤▶✲❈➹{}※卐Ψ∪∩∈∏のぁ≮≯∮∝∞∧∨∑≤≥≈＜＞⊙●★☆■♀『』◆▲∑βγδεζηθικλμνξπρστυφψωЁБГДЕЗИ王子墨前端攻城师七月王子墨前端攻城师',/*随机字母*/
